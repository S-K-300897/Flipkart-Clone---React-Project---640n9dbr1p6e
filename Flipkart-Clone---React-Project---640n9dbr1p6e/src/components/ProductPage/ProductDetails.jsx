...
function ProductDetails() {
    ...
    const { idk } = useParams();
    const url = `https://content.newtonschool.co/v1/pr/63b6c911af4f30335b4b3b89/products?id=${idk}`;
                ...
                <div className='productdetails'>
                    <div className="left__details">
                        ...
                        <div className='add_and_buy'>
                            ...
                            <button className='buy_now'><FlashOnIcon />BUY NOW</button>
                        </div>
                    </div>
                    <div className="right__details">
                        <h3>{data[0].title}</h3>

                        <div className='rating'>{data[0].rating.rate}<StarBorderIcon /></div>
